...
import pic from "@/app/image/nafis.jpg";
  ...
  return (
    <footer>
      <section className="bg-gray-100 py-12" id="contact">
        ...
        {/* Contact Content */}
        <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center md:justify-between">
          {/* Left: Title / Contact Info */}
          <div className="text-center md:text-left mb-8 md:mb-0">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Manage By</h2>
            <div className="flex justify-center md:justify-start mb-4">
              <Image src={pic} width={150} height={150} alt="nafis" className="rounded-full" />
            </div>
            <p className="text-gray-600 mb-4">Md Nafis Akbar</p>
            <a href="mailto:mdnafisakbar289@gmail.com" className="text-gray-600 block mt-4">Email: mdnafisakbar289@gmail.com</a>
