...
import { useState, useEffect } from 'react';
import Image from 'next/image';
import image1 from "@/app/image/s1.jpg"; // Ensure correct image paths
import image2 from "@/app/image/s2.jpg"; // Ensure correct image paths
import image3 from "@/app/image/s3.jpg"; // Ensure correct image paths
          ...
          >
            <div className="relative w-full h-full">
              <Image
                ...
                alt={`Slide ${slide.id}`}
                layout="fill" // Makes the image fill the container
                objectFit="contain" // Use 'contain' to ensure the image is fully visible without cropping
                className="w-full h-full" // Ensure the image is responsive
              />
              <div className="absolute bottom-10 left-0 right-0 text-center text-white bg-black bg-opacity-50 p-4 rounded-md">
                <h2 className="text-lg md:text-2xl font-bold">{slide.title}</h2>
                <p className="text-sm md:text-lg">{slide.description}</p>
